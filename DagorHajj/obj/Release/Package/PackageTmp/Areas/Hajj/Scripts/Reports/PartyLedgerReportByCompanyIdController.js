app.controller('PartyLedgerReportByCompanyIdController', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
    ...
    $scope.GetPartyLedgerReport = function () {
        $http({
            method: "GET",
            url: "/Hajj/Reports/PartyLedgerReportByCompanyId/" + paramId
