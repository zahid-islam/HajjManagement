...
(function(t, i, e, s) {
    ...
    h.prototype = {
        ...
        _init: function() {
            var i = this;
            this.$element.parent().hasClass("input-group") || this.$element.parent().hasClass("input-prepend") ? (this.$element.parent(".input-group").find(".input-group-addon").on({
